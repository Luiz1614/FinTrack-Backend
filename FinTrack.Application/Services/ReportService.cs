...
public class ReportService : IReportService
{
    ...
    public async Task<MonthlyReportDto> GetMonthlyReportAsync(int idAccount, int idUser, int year, int month)
    {
        var transactions = await _transactionRepository.GetTransactionByAccountAndMonthAsync(idAccount, idUser, year, month);
